...
const Sidebar = () => {
  ...
  return (
    <div className="bottom-0">
      <aside className="shadow-lg min-h-screen  rounded-lg  z-20  md:w-64 overflow-y-auto bg-white  block flex-shrink-0">
        <div className="py-4 text-gray-500 ">
          ...
          <div className="px-6 my-6">
            <button
              onClick={onLogout}
              className="items-center hidden md:block justify-between w-full px-4 py-2 text-sm font-medium leading-5 text-white transition-colors duration-150 bg-indigo-600 border border-transparent rounded-lg active:bg-purple-600 hover:bg-purple-700 focus:outline-none focus:shadow-outline-purple"
            >
              logout
            </button>
          </div>
