...
const UpdateProfile = () => {
  return (
    <>
      <div className="grid grid-cols-4  flex left-0  bg-white shadow-[0_4px_12px_0_rgba(0,0,0,0.07),_0_2px_4px_rgba(0,0,0,0.05)] data-[te-sidenav-hidden='false']:translate-x-0 dark:bg-zinc-800">
        <div className="col-span-1 flex flex-col shadow">
          <div class=" mt-6 ">
            <div id="header-content" class="pl-4 justify-center">
              <img
                className="w-20 h-20 rounded-full img-center"
      ...
      <nav
        ...
        class="fixed top-0 left-0 z-[1035] h-screen w-60 -translate-x-full overflow-hidden bg-white shadow data-[te-sidenav-hidden='false']:translate-x-0 dark:bg-zinc-800"
