  ...
  return (
    <>
      ...
      <div className="bg-white">
        <div className="mx-auto  py-2 sm:px-6 sm:pt-32 lg:px-8">
          <div className="relative isolate overflow-hidden bg-gray-300 px-6 pt-16 shadow-2xl sm:rounded-3xl sm:px-16 md:pt-24 lg:flex lg:gap-x-20 lg:px-24 lg:pt-0">
            <svg
