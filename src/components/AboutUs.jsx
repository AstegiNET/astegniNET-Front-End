...
export default function Example() {
  return (
    <div
      id="about"
      className="relative isolate overflow-hidden bg-gray-100 py-24 sm:py-32 mx-10 sm:rounded-3xl"
    >
      <svg
      ...
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        <div className="mx-auto max-w-2xl lg:mx-0">
          ...
          <p className="mt-6 text-lg leading-8 text-gray-900">
            Our mission is to provide accessible and high-quality education to
            learners. We believe that everyone deserves the opportunity to learn
            and grow, regardless of their background or circumstances.
          </p>
        </div>
